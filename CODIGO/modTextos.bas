...
Public Sub DrawText(ByVal left As Long, ByVal top As Long, ByVal Text As String, ByVal color As Long, Optional ByVal Alpha As Byte = 255, Optional ByVal Center As Boolean = False)
'*********************************************************
...
Dim TexInfo As D3DXIMAGE_INFO_A
    ...
    'Set the texture
    Set cfonts(1).Texture = DirectD3D8.CreateTextureFromFileEx(DirectDevice, App.path & "\Graficos\" & "font" & "1" & ".bmp", D3DX_DEFAULT, D3DX_DEFAULT, 0, 0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED, D3DX_FILTER_POINT, D3DX_FILTER_POINT, _
...
Dim v As Single
    ...
    FileNum = FreeFile
    Open App.path & "\Graficos\font1.dat" For Binary As #FileNum
